...
package com.byronh.space3d.shader;
...
//	int u_colorU;
//	int u_colorV;
	String data = "com/thesecretpie/shader/shaders";

	@Override
	public void init() {
		String vert = Gdx.files.classpath(data + "/default.vert").readString();
		String frag = Gdx.files.classpath(data + "/default.frag").readString();
		program = new ShaderProgram(vert, frag);
		if (!program.isCompiled()) {
			Gdx.app.log("TestShader", program.getLog());
...
//		program.setUniformi("u_texture", 0);
	...
	public void render(Renderable renderable) {
		program.setUniformMatrix(u_worldView, renderable.worldTransform);
...
//				attribute.color2.b);
	...
	public boolean canRender(Renderable renderable) {
		return true;//renderable.material.has(TextureAttribute.Diffuse);
	}
}