...
public class GradientColor {
	...
	public void addGradientPoint(double gradientPos, Color gradientColor) throws GdxRuntimeException {
	...
	public int findInsertionPos(double gradientPos) throws GdxRuntimeException {
		int insertionPos;
		for (insertionPos = 0; insertionPos < gradientPointCount; insertionPos++) {
			if (gradientPos < gradientPoints[insertionPos].position) {
				...
				throw new GdxRuntimeException("Invalid Parameter in Gradient Color");
			}
		}
		return insertionPos;
	}
	...
	public void insertAtPos(int insertionPos, double gradientPos, Color gradientColor) {
